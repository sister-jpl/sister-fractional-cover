...
conda create -n spectral-unmixing -y -c conda-forge julia=1.7 python=3.8 gdal=3.6.0 pandas=2.0.1
source activate spectral-unmixing
pip install Pillow

# Download snow climatology dataset
wget https://sister-ops-registry.s3.us-west-2.amazonaws.com/packages/LIN10A1_snow_climatology_13day.tif
